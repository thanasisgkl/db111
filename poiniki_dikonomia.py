...
def process_articles():
    try:
        ...
        with open('Κώδικας-Ποινικής-Δικονομίας.txt', 'r', encoding='utf-8') as file:
            text = file.read()
        ...
        # Αποθηκεύουμε σε CSV
        df.to_csv('poiniki_dikonomia.csv', index=False, encoding='utf-8')
        ...
        try:
            ...
            law_name = 'ΚΩΔΙΚΑΣ ΠΟΙΝΙΚΗΣ ΔΙΚΟΝΟΜΙΑΣ'

...
def process_articles():
    try:
        ...
        with open('Κώδικας-Πολιτικής-Δικονομίας.txt', 'r', encoding='utf-8') as file:
            text = file.read()
        ...
        # Αποθηκεύουμε σε CSV
        df.to_csv('politiki_dikonomia.csv', index=False, encoding='utf-8')
        ...
        try:
            ...
            law_name = 'ΚΩΔΙΚΑΣ ΠΟΛΙΤΙΚΗΣ ΔΙΚΟΝΟΜΙΑΣ'
